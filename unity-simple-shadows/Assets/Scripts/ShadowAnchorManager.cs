...
public class ShadowAnchorManager : MonoBehaviour {
    ...
    {
        RemoveAnchor();
        float surfaceHeight = anchorTransform.GetComponent<SetWorldAnchor4ShadowContrastExp>().GetSurfaceHeight(); 
        transform.localPosition = new Vector3(anchorTransform.localPosition.x, anchorTransform.localPosition.y + surfaceHeight, anchorTransform.localPosition.z);
